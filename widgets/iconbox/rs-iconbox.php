	...
	protected function render() {
		...
		<div class="rs-iconbox-area">
		    <div class="box-inner">
			    ...
			    <div class="text-area">
			    	<?php if(!empty($settings['title'])){ ?>
				    	<div class="iconbox-title">
				    		...
				    		<<?php echo esc_html($settings['title_tag']);?> <?php echo esc_attr($this->print_render_attribute_string('title')); ?>> <a href="<?php echo esc_url($settings['title_link']);?>" <?php echo wp_kses_post($link_open); ?>><?php echo esc_html($settings['title']);?></a></<?php echo esc_html($settings['title_tag']);?>>
			    ...
			    <div <?php echo esc_attr($this->print_render_attribute_string('badge_title')); ?>><?php echo esc_html ($settings['badge_title']);?></div>
			    <?php } ?>
