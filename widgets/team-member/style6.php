	...
	<div class="row">
 	<?php //******************//
		...
		while($best_wp->have_posts()): $best_wp->the_post();					
			...
			if($twitter!=''){
				$tw='<a href="'.$twitter.'" class="social-icon"> <i class="fa-brands fa-x-twitter"></i> </a>';
			}
			if($google_plus!=''){
		...
		<?php
			...
			if($twitter!=''){
				$tw_popup='<a href="'.$twitter.'" class="social-icon" '.$icon_style.'> <i class="fa-brands fa-x-twitter"></i> </a>';
			}
			if($google_plus!=''){
